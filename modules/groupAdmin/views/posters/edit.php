...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app','Advertisements'), 'url' => Url::to(['/group-admin/posters/index'])];
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <?php echo FileUploadUI::widget([
                    'name' => 'filename',
                    'url' => ['/group-admin/posters/upload-image', 'id' => $model->id],
                    'gallery' => true,
                    'fieldOptions' => [
                        'accept' => 'image/*'
                    ],
                ...
                $this->registerJs('$("#w0-fileupload").fileupload("option", "done").call($("#w0-fileupload"), $.Event("done"), {result: {files: '.$model->getImagesListed(null,true,'/group-admin/posters/delete-image').'}})',\yii\web\View::POS_READY); ?>
            </div>

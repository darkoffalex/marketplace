...
//            $changeUrl = Url::to(['/group-admin/short-links/status-change', 'id' => $model->id]);
    ...
    [
        ...
        'buttons' => [
            'update' => function ($url,$model,$key) {
                /* @var $model \app\models\ShortLink */
                return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Url::to(['/group-admin/short-links/update', 'id' => $model->id]), ['title' => Yii::t('app','Edit'), 'data-target' => '.modal-main', 'data-toggle'=>'modal']);
            },
            'delete' => function ($url,$model,$key) {
                /* @var $model \app\models\ShortLink */
                return Html::a('<span class="glyphicon glyphicon-trash"></span>', Url::to(['/group-admin/short-links/delete', 'id' => $model->id]), ['title' => Yii::t('app','Delete'), 'data-confirm' => Yii::t('app','Delete for eternity?')]);
            },
        ],
    ],
];
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="box">
            ...
            <?php if($user->getShortLinks()->count() == 0 || $user->isApprovedGroupAdmin()): ?>
                <div class="box-footer">
                    <a href="<?php echo Url::to(['/group-admin/short-links/create']); ?>" data-toggle="modal" data-target=".modal-main" class="btn btn-primary"><?= Yii::t('app','Create'); ?></a>
                </div>
            <?php endif; ?>
        </div>
    </div>
